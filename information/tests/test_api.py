...
class APITestCase(TestCase):
    def setUp(self):
        ...
        self.person_marge = Person.objects.create(index=2,
                                                  ...
                                                  address='742 Evergreen Terrace, Springfield',
                                                  phone='+123456789')
        self.person_ned = Person.objects.create(index=4,
                                                guid=uuid.uuid4(),
                                                balance=Decimal(23.45),
                                                age=65,
                                                registered=datetime.now(timezone.utc),
                                                ...
                                                phone='+134567890')
        self.person_maude = Person.objects.create(index=5,
                                                  guid=uuid.uuid4(),
    ...
    def test_get_company(self):
        ...
        self.assertDictEqual(json.loads(response.content.decode('UTF-8')),
                             {'employees': [{'name': 'Anthony Joseph'}, {'name': 'Homer Simpson'},
                                            {'name': 'Marge Simpson'}],
                              'name': 'TEST'})
    ...
    def test_get_person_food_likes(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertDictEqual(json.loads(response.content.decode('UTF-8')),
                             {'username': 'Anthony Joseph', 'age': 34, 'fruits': ['apple', 'banana'],
                              'vegetables': ['carrot']})
    ...
    def test_getmutual_friends_alive_with_brown_eyes(self):
        ...
        self.assertDictEqual(json.loads(response.content.decode('UTF-8')),
                             {'mutual_friends': [{'name': 'Maude Flanders'}],
                              'person_one': {'address': '742 Evergreen Terrace, Springfield',
                                             'age': 45,
                                             'name': 'Homer Simpson',
                                             'phone': '+123456789'},
                              'person_two': {'address': '742 Evergreen Terrace, Springfield',
                                             'age': 56,
                                             'name': 'Marge Simpson',
                                             'phone': '+123456789'}})
    ...
    def test_getmutual_friends_alive_with_brown_eyes_no_mutual_friends(self):
        ...
        self.assertDictEqual(json.loads(response.content.decode('UTF-8')),
                             {'mutual_friends': [],
                              'person_one': {'address': '740 Evergreen Terrace, Springfield',
                                             'age': 65,
                                             'name': 'Ned Flanders',
                                             'phone': '+134567890'},
                              'person_two': {'address': '742 Evergreen Terrace, Springfield',
