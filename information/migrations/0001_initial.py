# Generated by Django 3.0.4 on 2020-03-21 10:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=200)),
                ('type', models.CharField(choices=[('frt', 'Fruit'), ('veg', 'Vegetable')], default='frt', max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=10)),
                ('picture', models.URLField()),
                ('age', models.IntegerField()),
                ('eye_colour', models.CharField(max_length=100)),
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('N', 'Other/Not specified')], default='N', max_length=1)),
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='employees', to='information.Company')),
                ('favourite_foods', models.ManyToManyField(to='information.Food')),
                ('friends', models.ManyToManyField(related_name='friends_of', to='information.Person')),
